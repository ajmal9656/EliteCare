...
import {  Application, Doctor, GetApplication, getAppointments, GetDoctor, getSpecialization, getTransaction, GetUser, MonthlyDashboardStats, MonthlyStats, Specialization, User} from "../../interface/adminInterface/adminInterface";
