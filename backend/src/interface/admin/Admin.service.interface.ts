...
import {  Application, Appointment, Doctor, GetApplication, GetDoctor, getSpecialization, getTransaction, MonthlyDashboardStats, Specialization, User } from "../adminInterface/adminInterface"
