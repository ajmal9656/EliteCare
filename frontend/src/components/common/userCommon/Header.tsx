...
function Header() {
  ...
  <header className=" sticky top-0 bg-blue-600 min-h-[2rem] w-[100%] flex justify-center" >
  <div className="mx-auto max-w-screen-xl px-1 sm:px-6  w-[100%] mr-0"
  >
    <div className="flex h-16 items-center  ">
      ...
      <a className="block text-teal-600" href="#">
        ...
        <svg className="h-8" viewBox="0 0 28 24" fill="none" xmlns="">
          {/* <path
      ...
      {/* Navigation and buttons on the right side */}
      <div className="flex items-center gap-4 mr-0 w-[50%]">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="block md:hidden">
            <button className="rounded bg-gray-100 p-2 text-white transition hover:text-white/75">
              <svg
